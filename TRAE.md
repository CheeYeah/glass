...
#### 文件清理
已移除根目录下不再使用的 `en.json` 和 `zh-CN.json` 文件，统一使用按语言和命名空间组织的文件结构。

#### 组件适配
- [x] SettingsView.js - 包含语言选择器
- [x] ShortCutSettingsView.js
